...
def renderizar_aba_1():
    ...
    # --- SEÇÃO EQUIPAMENTO REVISADA (SUBSTITUA O CONTEÚDO DO EXPANDER POR ISSO) ---
st.markdown("### ⚙️ Especificações do Equipamento")
with st.expander("Detalhes Técnicos do Ativo", expanded=True):
    e1, e2, e3, e4 = st.columns(4) # Mudamos para 4 colunas
    ...
    with e3:
        # AJUSTE: Capacidade agora guarda o número puro para os cálculos
        ...
        # Fluido (Sua lógica perfeita mantida)
